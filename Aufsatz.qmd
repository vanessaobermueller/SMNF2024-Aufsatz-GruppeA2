...
keys <- list(ATI = c("ATI.1.", "ATI.2.","-ATI.3.","ATI.4.","ATI.5.","-ATI.6.","ATI.7.","ATI.8.","-ATI.9."))
scored <- psych::scoreItems(keys, ergebnissurvey)
ergebnissurvey <- ergebnissurvey %>% cbind(scored$scores)

ergebnissurvey <- ergebnissurvey %>% mutate(HTC_E = ifelse(first_variant == "eva-ai", HTC_1, HTC_2))
