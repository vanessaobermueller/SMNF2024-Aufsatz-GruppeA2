...
**GitHub Repository:** https://github.com/vanessaobermueller/SMNF2024-Aufsatz-GruppeA2.git **Fuer die Abgabe aktueller GitHub Hash:** 3654615
...
Grundlegend stellen wir uns primär die Frage, ob das Alter eines Menschens ein entscheidener Faktor bei der Konzipierung von KI-Tools zur Dedektion von Misinformationen ist und ob es in Hinblick dessen, Zusammenhänge zwischen dem Alter und unter anderem der Techniaffinität oder dem Vertrauen gegenüber solcher KI-Tools gibt. Damit stellt sich die Frage, wie dynamisch und/oder individuell solche KI-Tools aufgebaut werden müsssen damit diese über Altersgrenzen hinweg funktionieren und verstanden werden. 
...
#| message: false
#| warning: false
#| fig-cap: "Zusammenhang zwischen dem Alter und dem gemessenen ATI-Score gemessen durch einen t-test"


#t_test_precision_eva_ai <- t.test(ergebnissurvey$age, ergebnissurvey$, alternative = "two.sided")
