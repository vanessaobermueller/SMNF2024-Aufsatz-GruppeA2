...
[Hier klicken, um die PDF-Datei herunterzuladen - "Einwilligungserklärung_Anna"](SMNF_Einwilligungserklaerung_Anna.pdf)

[Hier klicken, um die PDF-Datei herunterzuladen - "Einwilligungserklärung_Kaja"](SMNF_Einwilligungserklaerung_Kaja.pdf)

[Hier klicken, um die PDF-Datei herunterzuladen - "Einwilligungserklärung_Zelda"](SMNF_Einwilligungserklaerung_Zelda.pdf)

[Hier klicken, um die PDF-Datei herunterzuladen - "Einwilligungserklärung_Vanessa"](SMNF_Einwilligungserklärung_Vanessa.pdf)


## Anhang 3 - Transkription der Interviews

[Hier klicken, um die PDF-Datei herunterzuladen - "Transkription_1 + Einwilligungserklärung"](SMNF_Transkript_A2_1_Einwilligungserklaerung_Lena.pdf)

[Hier klicken, um die PDF-Datei herunterzuladen - "Transkription_2"](SMNF_Transkript_Interview_A2_3 (1).pdf)

[Hier klicken, um die PDF-Datei herunterzuladen - "Transkription_3"](SMNF_Transkript_A2_1_Einwilligungserklaerung_Lena.pdf)

[Hier klicken, um die PDF-Datei herunterzuladen - "Transkription_4"](SMNF_Transkript_A2_4.pdf)

[Hier klicken, um die PDF-Datei herunterzuladen - "Transkription_5"](SMNF_Transkript_A2_5.pdf)
